...
El **Equipo MR** es el encargado de diseñar y estructurar los cimientos de la gestión de activos y recursos del hospital. Nuestro compromiso es garantizar un control preciso sobre el equipamiento y los suministros que hacen posible la atención médica.
